...
if (!I18nGallery::checkPrerequisites()) {
  ...
  if (!isset($msg)) {
    if (i18n_gallery_save($gallery, @$_GET['name'])) {
      ...
      if (@$name) $msg .= ' <a href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_edit&amp;name='.$name.'&amp;new='.@$_POST['post-name'].'&amp;undo">' . i18n_r('UNDO') . '</a>';
      $success = true;
...
<?php } ?>
    ...
    <form method="post" id="galleryForm" action="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_edit&amp;name=<?php echo @$name; ?>" accept-charset="utf-8">
...
?>
      ...
      &nbsp;&nbsp; <?php i18n('OR'); ?> &nbsp;&nbsp;
      <a class="cancel" href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_overview"><?php i18n('CANCEL'); ?></a>
<?php if (@$name) { ?>
      &nbsp;/&nbsp; 
      <a class="cancel" href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_overview&amp;name=<?php echo $name; ?>&amp;delete"><?php i18n('i18n_gallery/DELETE'); ?></a>
<?php } ?>
    </form>
    <p style="text-align:center; margin:20px 0 0 0;">&copy; 2011 Martin Vlcek - Please consider a <a href="http://mvlcek.bplaced.net/">Donation</a></p>
    ...
    <script type="text/javascript">
      function addImage(filename, size, width, height) {
