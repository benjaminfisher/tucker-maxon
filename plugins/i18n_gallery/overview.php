...
if (!I18nGallery::checkPrerequisites()) {
  ...
  if (i18n_gallery_delete_it($name)) {
    $msg = i18n_r('i18n_gallery/DELETE_SUCCESS').' <a href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_edit&amp;name='.$name.'&amp;new='.$name.'&amp;undo">' . i18n_r('UNDO') . '</a>';
    $success = true;
  } else {
...
<?php foreach ($galleries as $gallery) { ?>
        <tr>
          <td><a href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_edit&amp;name=<?php echo @$gallery['name']; ?>" title="<?php echo i18n_r('i18n_gallery/EDITGALLERY_TITLE').': '.cl(@$gallery['title']); ?>"><?php echo htmlspecialchars(@$gallery['title']); ?></a></td>
          ...
          <td class="delete">
            <a href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_overview&amp;name=<?php echo @$gallery['name']; ?>&amp;delete" title="<?php echo i18n_r('i18n_gallery/DELETEGALLERY_TITLE').': '. cl($gallery['title']); ?>">X</a>
          </td>
        </tr>
<?php } ?>
      </tbody>
