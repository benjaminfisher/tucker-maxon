<?php
  ...
  if (isset($_GET['deletecache'])) {
    ...
    if (i18n_gallery_settings_save($settings)) {
      ...
      $msg .= ' <a href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_configure&amp;undo">' . i18n_r('UNDO') . '</a>';
      $success = true;
      $settings = i18n_gallery_settings(true);
    } else {
...
?>
  <form method="post" class="largeform" id="settingsForm" action="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_configure" accept-charset="utf-8">
    ...
    /
    <a class="cancel" href="loadtab.php?id=i18n_gallery&amp;item=i18n_gallery_configure&amp;deletecache"><?php i18n('i18n_gallery/DELETE_CACHE'); ?></a>
  </form>
